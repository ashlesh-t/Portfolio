...
async function DELETE(req, { params }) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ProjectModel"].findByIdAndDelete(params.id);
...
async function PUT(req, { params }) {
    try {
        ...
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ProjectModel"].findByIdAndUpdate(params.id, body, {
            new: true
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bc46f404._.js.map