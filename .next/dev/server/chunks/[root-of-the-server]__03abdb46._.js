...
"[project]/app/api/profile/resume/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
        const profile = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ProfileModel"].findOne({});
        if (profile) {
            profile.resumeBase64 = resumeBase64;
            await profile.save();
        } else {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ProfileModel"].create({
                name: "Ashlesh T",
                title: "Developer",
                resumeBase64
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__03abdb46._.js.map