...
"[project]/app/api/achievements/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AchievementModel"].find({}).sort({
            order: 1,
            date: -1
        }).lean();
...
async function POST(req) {
    try {
        ...
        const newDoc = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AchievementModel"].create(body);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__85fa86f4._.js.map