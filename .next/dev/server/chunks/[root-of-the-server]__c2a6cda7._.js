...
async function GET() {
    try {
        ...
        const projects = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ProjectModel"].find({}).sort({
            featured: -1,
            order: 1,
            createdAt: -1
        }).lean();
...
async function POST(req) {
    try {
        ...
        const newProject = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ProjectModel"].create(body);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c2a6cda7._.js.map